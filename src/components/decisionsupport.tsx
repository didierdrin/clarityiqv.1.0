...
//   const processInitiatives = (data: any[]) => {
//     // Map raw Firebase data into table-compatible format
//     return data.map(item => ({
//       initiative: item.name,
//       startDate: item.lastSyncedDate || "N/A",
//       endDate: calculateEndDate(item.syncFrequency, item.lastSyncedDate),
...
//     switch (syncFrequency) {
//       case "Daily":
//         start.setDate(start.getDate() + 7); // Example: +7 days for daily tasks
//         break;
//       case "Weekly":
//         start.setDate(start.getDate() + 30); // Example: +30 days for weekly tasks
//         break;
//       case "Monthly":
//         start.setMonth(start.getMonth() + 6); // Example: +6 months for monthly tasks
//         break;
//       default:
//         return "N/A";
//     }
